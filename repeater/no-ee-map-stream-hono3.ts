...
class ConnectionManager {
  ...
  addHandlerToChannel(channel: string, ssid: string, handler: Handler) {
    ...
    this.handlersBySsidByChannel.set(
      [ssid, channel],
      this.handlersBySsidByChannel.get([ssid, channel])?.add(handler) ??
        new Set([handler])
    );

    console.log("wuuut", this.handlersBySsidByChannel);
    console.log(
      "wuuut get ",
      this.handlersBySsidByChannel.get([ssid, channel])
    );

    console.log("WOOOO", this.getHandlersBySsidByChannel(ssid, channel));
  }

  getHandlersBySsidByChannel(ssid: string, channel: string) {
    return this.handlersBySsidByChannel.get([ssid, channel]);
  }
  ...
  removeHandlerFromChannel(channel: string, ssid: string, handler: Handler) {
    ...
    this.handlersBySsidByChannel.get([ssid, channel])?.delete(handler);
  }
...
function subscribeSsidToChannel(ssid: string, channel: string) {
  ...
  // const channels = cm.getChannelsBySsid(ssid!);
  ...
  console.log("ZZZZ", allSsidHandlersForChannel);
}
...
function unsubscribeSsidFromChannel(ssid: string, channel: string) {
  ...
  console.log("allSsidHandlersForChannel", allSsidHandlersForChannel);
